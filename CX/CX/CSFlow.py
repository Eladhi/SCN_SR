...
import CX.CX.enums as enums
import tensorflow as tf
from CX.CX.enums import TensorAxis, Distance
...
def CX_loss(T_features, I_features, distance=Distance.L2, nnsigma=float(1.0)):
    ...
    T_features = tf.convert_to_tensor(T_features.detach().cpu())
    I_features = tf.convert_to_tensor(I_features.detach().cpu())
