...
import json
from CX.CX.enums import Distance
import torch
import numpy as np
import re
...
config.vgg_model_path = './CX/imagenet-vgg-verydeep-19.mat'
#---------------------------------------------
...
config.CX.max_sampling_1d_size = 70
# config.dis.feat_layers = {'conv1_1': 1.0,'conv2_1': 1.0, 'conv3_1': 1.0, 'conv4_1': 1.0,'conv5_1': 1.0}
config.CX.feat_layers = {'conv3_2': 1.0, 'conv4_2': 1.0} # conv3_2 = 14 , conv4_2 = 22
config.CX.feat_content_layers = {'conv4_2': 1.0}  # for single image ; conv4_2 = 22
